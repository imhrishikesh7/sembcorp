        ...
        <div className='marginal'>
            ...
            <div className='md:flex md:justify-between md:items-center my-4'>
                <div className='md:w-[30%] md:pl-2 md:border-l md:border-black'>
                    ...
                    <Link to="/vipul-tuli" className='border-b-2 border-[#00565C] text-[#00565C]'>Read More</Link>
                </div>
                <div className='md:w-[30%] md:pl-2 md:border-l md:border-black'>
                    <div>
                    ...
                    <Link to="/appakudal-nithyanand" className='border-b-2 border-[#00565C] text-[#00565C]'>Read More</Link>
                </div>
                <div className='md:w-[30%] md:pl-2 md:border-l md:border-black'>
                    <div>
                    ...
                    <Link to="/nuraliza-osman" className='border-b-2 border-[#00565C] text-[#00565C]'>Read More</Link>
                </div>
